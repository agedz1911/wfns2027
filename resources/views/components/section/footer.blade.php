<footer class="pt-20 text-center text-white relative mt-10">
    ...
    <div class="absolute inset-0 bg-gradient-to-b from-[#044b4a] to-[#018284]/90"></div>
    <div class="relative">
        <div class="flex flex-col items-center w-full max-w-4xl m-auto">
            ...
            <div class="border-b border-white m-auto mb-6 mt-4 w-full max-w-2xl">
                ...
                <div class="py-5 mt-3">
                    <ul class="m-0 p-0 flex flex-row gap-5 lg:gap-8 justify-center">
                        <li class="bg-red-600 rounded-md p-2 w-10 hover:bg-red-800 tooltip-bottom tooltip"
            ...
            <div class="pb-10 mt-4">
                <ul class="p-0 m-0 flex flex-row flex-wrap gap-4 lg:gap-6 justify-center">
                    <li class="text-sm font-normal hover:text-red-500 hover:underline"><a href="{{route('organizing-committee')}}">Committee</a></li>
                    <li class="text-sm font-normal hover:text-red-500 hover:underline"><a href="{{route('faculties')}}">Faculties</a></li>
                    <li class="text-sm font-normal hover:text-red-500 hover:underline"><a href="{{route('program-at-glance')}}">Schedule</a></li>
                    <li class="text-sm font-normal hover:text-red-500 hover:underline"><a href="{{route('registration')}}">Registration</a></li>
                    <li class="text-sm font-normal hover:text-red-500 hover:underline"><a href="{{route('submission')}}">Submission</a></li>
                    </li>
                </ul>
            </div>
        </div>
